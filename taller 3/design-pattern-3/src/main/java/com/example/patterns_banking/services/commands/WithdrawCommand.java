...
import com.example.patterns_banking.models.decorator.LimitedAccountWhithdrawDecorator;
...
public class WithdrawCommand implements ICommand<Account> {
    ...
    public Account execute() {
        ...
        Account accountWithdraw = new LimitedAccountWhithdrawDecorator(account);
        accountWithdraw.withdraw(amount);

        return accountRepository.save(accountWithdraw);
    }
}